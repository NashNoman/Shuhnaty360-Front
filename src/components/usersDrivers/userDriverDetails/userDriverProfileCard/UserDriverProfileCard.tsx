...
const UserDriverProfileCard = ({ moreInfoData, personalInfoData, menuActions, page }: any) => {
  return (
    <>
      ...
      <div className='w-full flex flex-col justify-center items-center mt-8'>
        ...
        <h1 className='mt-4 mb-2 text-[#1A1A1A] font-bold text-xl'>{personalInfoData.name}</h1>
        {page === 'user' ? (
          <h6
            className={`text-sm ${
              personalInfoData.status === 'نشط' ? 'text-[#2E853F]' : 'text-[#666666]'
            } font-bold`}
          >
