...
const ShipmentPage = ({ shipmentsData }: any) => {
  ...
  const fieldsToCheck = [
    ...
    const sortedShipments = [...shipmentsData].sort((a: any, b: any) => a.id - b.id);


  const filteredData = sortedShipments.filter((shipment: any) =>
