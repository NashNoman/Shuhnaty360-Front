...
const DelayedShipment = () => {
  const [isUpdateShipmentStatusArea, setIsUpdateShipmentStatusArea] = useState(false);
  ...
  return (
    <>
      ...
      {!isUpdateShipmentStatusArea ? (
        <>
          <h1 className='w-full text-[#071309] font-Rubik text-center flex flex-col items-center gap-2 bg-[#FEDE9A] py-2 px-6 rounded-lg my-8'>
            الشحنة متأخرة
          </h1>
          <button
          ...
          >
            <span className='font-Rubik text-[#DD7E1F] text-lg'>تحديث الحالة</span>
            <img
              src={editIcon}
              alt=''
            />
